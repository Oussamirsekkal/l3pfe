export default function Home() {
    ...
    return (
        ...
        <>
            <section
                className="mx-auto my-10 flex max-w-xl flex-col rounded-3xl border-blue-300 px-4 py-10 text-gray-700 sm:border-8 sm:px-10 lg:max-w-screen-lg lg:flex-row">
                <div className="mr-2">
        ...
        <span className="text-blue-400">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
            ...
            <path strokeLinecap="round" strokeLinejoin="round"
                ...
                <div className="h-96">
                    <img className="h-full w-full object-contain" src="/media/benefits.png" alt=""/>
                </div>
            </section>
