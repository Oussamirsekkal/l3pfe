        ...
        <div className="grid grid-cols-8 pt-3 sm:grid-cols-10">
            ...
            <div className="col-span-2 hidden sm:block">
                <ul>
                    ...
                    <li className="mt-5 cursor-pointer border-l-2 border-transparent px-2 py-2 font-semibold transition hover:border-l-blue-700 hover:text-blue-700">Your child</li>
                    ...
                    <li className="mt-5 cursor-pointer border-l-2 border-transparent px-2 py-2 font-semibold transition hover:border-l-blue-700 hover:text-blue-700">security</li>
                </ul>
            </div>
            ...
            <div className="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <button className="inline-flex text-sm font-semibold text-blue-600 underline decoration-2">Change
                    </button>
                </div>
                <hr className="mt-4 mb-8"/>
                ...
                <p className="mt-2">Can&apos;t remember your current password. <a
                    className="text-sm font-semibold text-blue-600 underline decoration-2" href="#">Recover Account</a></p>
