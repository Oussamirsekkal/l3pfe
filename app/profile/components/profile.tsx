...
import {FaServer, FaPlusCircle, FaEye, FaCheck, FaSave} from 'react-icons/fa';
...
// In Profile component
    ...
    return (
    <div className="mx-4 min-h-auto max-w-auto-xl sm:mx-8 xl:mx-auto">
        <h1 className="border-b py-6 text-4xl font-semibold">Settings</h1>
        <div className="grid grid-cols-8 pt-3 sm:grid-cols-10">
            <div className="relative my-4 w-56 sm:hidden">
                <input className="peer hidden" type="checkbox" name="select-1" id="select-1"/>
                <label
                       className="flex w-full cursor-pointer select-none rounded-lg border p-2 px-3 text-sm text-gray-700 ring-blue-700 peer-checked:ring">Accounts </label>
                ...
                <ul className="max-h-0 select-none flex-col overflow-hidden rounded-b-lg shadow-md transition-all duration-300 peer-checked:max-h-56 peer-checked:py-3">
                    <li className="cursor-pointer px-3 py-2 text-sm text-slate-600 hover:bg-blue-700 hover:text-white" onClick={()=>{setactivesection("profile")}}>Profile</li>
                    <li className="cursor-pointer px-3 py-2 text-sm text-slate-600 hover:bg-blue-700 hover:text-white" onClick={()=>{setactivesection("children")}}>Your children</li>
                    <li className="cursor-pointer px-3 py-2 text-sm text-slate-600 hover:bg-blue-700 hover:text-white" onClick={()=>{setactivesection("notifications")}}>Notifications</li>
                </ul>
            </div>

            <div className="col-span-2 hidden sm:block">
                <ul>
                    <li className="mt-5 cursor-pointer border-l-2 border-transparent px-2 py-2 font-semibold transition hover:border-l-blue-700 hover:text-blue-700" onClick={()=>{setactivesection("profile")}}>Profile</li>
                    <li className="mt-5 cursor-pointer border-l-2 border-transparent px-2 py-2 font-semibold transition hover:border-l-blue-700 hover:text-blue-700" onClick={()=>{setactivesection("children")}}>Your children</li>
                    <li className="mt-5 cursor-pointer border-l-2 border-transparent px-2 py-2 font-semibold transition hover:border-l-blue-700 hover:text-blue-700" onClick={()=>{setactivesection("notifications")}}>Notifications</li>
                </ul>
            </div>
                ...
                <div className="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
                    ...
                    <div className="py-20 text-gray-700 mt-0 ">
                        <div className="flex flex-col lg:flex-row items-center justify-between mb-8">
                            ...
                            {showAddChild && <AddChild onCancel={handleCancelClick} />}
                        ...
                        <form className="flex flex-col lg:flex-row gap-8 lg:space-x-8 items-center">
                            <div className="relative w-full lg:w-96 h-32">
                                <input className="peer hidden" id="radio_1" type="radio" name="radio" onClick={() => {
                                    setchildaction("add")
                                }} defaultChecked/>
                                <label
                            ...
                            <div className="relative w-full lg:w-96 h-32">
                                <input className="peer hidden" id="radio_2" type="radio" name="radio" onClick={()=>{setchildaction("manage")}}/>
                                <label
                                    className="peer-checked:border-2 peer-checked:border-blue-400 peer-checked:bg-blue-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4 pr-16"
                                    htmlFor="radio_2">
