...
export default function Whyus() {
    ...
    return (
        <div className="w-auto">
            ...
            <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="284.2684" y1="452.9162" x2="284.2684"
              ...
              <path fill="#d500f9" className="primary-color" d="M475.6,460.2H461v-53.8h14.6V460.2z"></path>
                            ...
                            <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Lorem ipsum
                                dolor sit amet consectetur adipisicing elit. Quasi eligendi dolore ipsum.</p>
                        </div>
                    </div>
                    <div className="mt-8 lg:mt-10 lg:w-1/2">
                        <div className="flex flex-col items-start lg:pr-16">
                            <div className="w-16">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                     xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"
                                     enableBackground="new 0 0 512 512" xmlSpace="preserve">
            <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="223.5286" y1="383.3321" x2="223.5286"
              ...
              <path fill="#ffea00" className="secondary-color" d="M78.5,20.5L17.5,81.4V20.5H78.5z"></path>
                            ...
                            <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Lorem,
                                ipsum dolor sit amet consectetur adipisicing elit. Sit ad tenetur sequi exercitationem
                                eveniet.</p>
                        </div>
                    </div>
                    <div className="mt-8 lg:mt-10 lg:w-1/2">
                        <div className="flex flex-col items-start lg:pr-16">
                            <div className="w-16">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                     xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"
                                     enableBackground="new 0 0 512 512" xmlSpace="preserve">
            <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="197.4505" y1="414.8024" x2="187.5514"
              ...
              <stop offset="0" className="primary-color-gradient" ></stop>
                <stop offset="1" className="secondary-color-gradient" ></stop>
                            ...
                            <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Lorem ipsum
                                dolor, sit amet consectetur adipisicing elit. A adipisci molestiae vero esse..</p>
                        </div>
                    </div>
                    <div className="mt-8 lg:mt-10 lg:w-1/2">
                        <div className="flex flex-col items-start lg:pr-16">
                            <div className="w-16">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                     xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"
                                     enableBackground="new 0 0 512 512" xmlSpace="preserve">
            <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="486.0444" y1="259.5021" x2="42.3063"
              ...
              <stop offset="0" className="primary-color-gradient" ></stop>
                <stop offset="1" className="secondary-color-gradient" ></stop>
                            ...
                            <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Lorem ipsum
                                dolor sit amet, consectetur adipisicing elit. Odio impedit reiciendis optio deleniti
                                odit illum nisi deserunt possimus..</p>
                        </div>
                    </div>
                </div>
            </div>
