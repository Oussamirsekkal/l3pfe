...
export default function Whyus() {
    ...
    return (
        <div className="w-auto">
            <div className="mx-auto mt-10 w-full max-w-auto-xl px-4">
                ...
                <div className="flex flex-col justify-between lg:flex-row lg:flex-wrap">
                    <div className="mt-8 lg:mt-10 lg:w-1/2">
                        <div className="flex flex-col items-start lg:pr-16">
                            ...
                            <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Our
                                educational platform uses Blockly to teach children programming in an interactive and
                                engaging way. With our visual programming interface, kids can learn coding concepts by
                                dragging and dropping code blocks, making it easy for them to grasp programming
                                fundamentals.</p>
                        </div>
                    </div>
                    <div className="mt-8 lg:mt-10 lg:w-1/2">
                        <div className="flex flex-col items-start lg:pr-16">
                            ...
                            <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Our
                                platform is designed to help children learn faster by breaking down complex programming
                                concepts into bite-sized lessons and interactive exercises. With our step-by-step
                                guidance and immediate feedback, kids can build their coding skills at their own
                                pace.</p>
                        </div>
                    </div>
                    <div className="mt-8 lg:mt-10 lg:w-1/2">
                        <div className="flex flex-col items-start lg:pr-16">
                            <div className="w-16">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                     xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"
                                     enableBackground="new 0 0 512 512" xmlSpace="preserve">
                                    <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="197.4505"
                                                    y1="414.8024" x2="187.5514"
                                                    y2="248.4989" className="gradient-element">
                                        <stop offset="0" className="primary-color-gradient"></stop>
                                        <stop offset="1" className="secondary-color-gradient"></stop>
                                    </linearGradient>
                                    <path fill="url(#SVGID_1_)"
                                          d="M45.6,460L280,238.7c11.3-10.6,28.7-11,40.5-1l22.1,18.9l-186,162.7c0,0-67.4,2.7-101,50.6L45.6,460z        "></path>
                                    <path
                        ...
                        <div className="flex flex-col items-start lg:pr-16">
                            <div className="w-16">
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                     xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"
                                     enableBackground="new 0 0 512 512" xmlSpace="preserve">
                                    <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="486.0444"
                                                    y1="259.5021" x2="42.3063"
                                                    y2="259.5021" className="gradient-element">
                                        <stop offset="0" className="primary-color-gradient"></stop>
                                        <stop offset="1" className="secondary-color-gradient"></stop>
                                    </linearGradient>
                                    <path fill="url(#SVGID_1_)"
                                          d="M496.8,369.7H58.2c-11.6,0-21-9.4-21-21V170.7c0-11.8,9.6-21.4,21.4-21.4h438.1V369.7z"></path>
                                    <path
